...
import { Loader2, User, Trophy, Heart } from 'lucide-react';
    ...
    <form onSubmit={handleSubmit} className="space-y-6 pb-32 md:pb-10">
      ...
      <div className="bg-gray-900/50 p-4 rounded-3xl border border-gray-800 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input
            ...
            className="w-full bg-[#0a0f1a] border border-gray-800 p-4 rounded-2xl text-right text-white focus:border-blue-500 outline-none"
            onChange={(e) =>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <input
          ...
          className="bg-gray-900 border border-gray-800 p-4 rounded-2xl text-white outline-none focus:border-blue-500"
          onChange={(e) =>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full bg-gray-900 border border-gray-800 p-4 rounded-2xl text-white color-scheme-dark"
            onChange={(e) =>
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full bg-gray-900 border border-gray-800 p-4 rounded-2xl text-white outline-none"
            onChange={(e) =>
      ...
      <div className="space-y-4 bg-gray-900/50 p-4 rounded-3xl border border-gray-800">
        ...
        <div className="grid grid-cols-1 gap-3">
          <input
            value={formData.cses_username}
            placeholder="CSES Username"
            className="w-full bg-black/20 border border-gray-800 rounded-2xl px-5 py-4 outline-none focus:border-blue-500"
            onChange={(e) =>
              setFormData({ ...formData, cses_username: e.target.value })
            }
          />
          ...
          <input
            ...
            className="bg-[#0a0f1a] border border-gray-800 p-4 rounded-2xl text-sm text-white focus:border-blue-500 outline-none"
            onChange={(e) =>
              setFormData({
                ...formData,
      ...
      <div className="space-y-2">
        ...
        <textarea
          value={formData.health_flags}
          placeholder="Any medical conditions..."
          className="w-full bg-gray-900 border border-gray-800 p-4 rounded-2xl text-sm h-28 text-white outline-none focus:border-red-500/50"
          onChange={(e) =>
            setFormData({ ...formData, health_flags: e.target.value })
          }
        />
      </div>
